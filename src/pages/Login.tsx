      ...
      setTimeout(() => {
        try {
          ...
          if (payload.matricula) {
            localStorage.setItem("user_matricula", payload.matricula);
          }
          ...
          <div className="px-8 pt-12 pb-12 flex flex-col items-center text-center">
            ...
            <div className="mb-10 flex items-center gap-3">
              ...
              <div className="flex flex-col items-start leading-none pl-3 border-l-2 border-gray-100">
                <span className="font-black text-2xl tracking-tighter text-gray-900">IFPB</span>
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Monteiro</span>
              </div>
            </div>

            <h1 className="mb-2 text-5xl font-black tracking-tighter text-gray-900">ACVD</h1>
            <h2 className="mb-10 text-[11px] font-bold text-[#008060] uppercase tracking-[0.2em] leading-tight">
              Ajuda de Custo de Viagem de Discentes
            </h2>

            <div className="w-full space-y-8">
              <p className="text-sm leading-relaxed text-gray-500 px-6">
                Bem-vindo ao portal. Utilize sua <strong>conta acadêmica</strong> oficial para realizar a solicitação.
              </p>
              
              <button 
                onClick={handleGoogleLogin}
                className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-[#008060] px-6 py-5 text-base font-bold text-white shadow-lg shadow-emerald-100 transition-all duration-200 hover:bg-[#00664d] hover:-translate-y-0.5 active:scale-95"
              >
            ...
            <div className="mt-12 flex items-center justify-center gap-6 text-[10px] font-black text-gray-300 uppercase tracking-widest">
              <a className="hover:text-[#008060] transition-colors" href="#">Galera</a>
              <span>•</span>
              <a className="hover:text-[#008060] transition-colors" href="#">De TI</a>
            </div>
          </div>

          {/* Rodapé Interno Estilizado Fata terminar DAVI*/}
